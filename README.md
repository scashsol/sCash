<div align="center">
  ...
  <p>
    <a href="https://devcash-lang.com"><img alt="Tutorials" src="https://img.shields.io/badge/docs-tutorials-blueviolet" /></a>
    <a href="https://discord.gg/devcash"><img alt="Discord Chat" src="https://img.shields.io/discord/889577356681945098?color=blueviolet" /></a>
    <a href="https://opensource.org/licenses/Apache-2.0"><img alt="License" src="https://img.shields.io/github/license/devcash/devcash?color=blueviolet" /></a>
  </p>
</div>

## What is devcash?

devcash is a groundbreaking framework built for the Solana ecosystem, providing developers with seamless tools for writing privacy-focused programs and creating encrypted tokens that protect user transaction data while maintaining Solana's incredible speed and low costs.
...
devcash is the first framework to bring Zcash-style privacy to Solana, enabling truly private transactions at scale.

> [!NOTE]
> devcash combines Solana's speed and affordability with enterprise-grade privacy. With 400ms block times, $0.00025 average transaction fees, and support for 65,000+ TPS, you get the performance you need with the privacy users deserve. If you're familiar with Anchor or native Solana development, you'll feel right at home with devcash's privacy-enhanced approach.
...
### devcash - Privacy for Solana
devcash leverages Solana's infrastructure to provide:
...
For a quickstart guide and in-depth tutorials, see the [devcash book](https://book.devcash-lang.com) and the [devcash documentation](https://devcash-lang.com).

To jump straight to examples, go [here](https://github.com/devcash/devcash/tree/master/examples). For the latest Rust and TypeScript API documentation, see [docs.rs](https://docs.rs/devcash-lang) and the [typedoc](https://www.devcash-lang.com/docs/clients/typescript).

## Packages

| Package                 | Description                                              | Version                                                                                                                          | Docs                                                                                                            |
| :---------------------- | :------------------------------------------------------- | :------------------------------------------------------------------------------------------------------------------------------- | :-------------------------------------------------------------------------------------------------------------- |
| `devcash-lang`           | Rust primitives for writing privacy-preserving programs         | [![Crates.io](https://img.shields.io/crates/v/devcash-lang?color=blue)](https://crates.io/crates/devcash-lang)                     | [![Docs.rs](https://docs.rs/devcash-lang/badge.svg)](https://docs.rs/devcash-lang)                                |
| `devcash-spl`            | CPI clients for private SPL tokens and standards | [![crates](https://img.shields.io/crates/v/devcash-spl?color=blue)](https://crates.io/crates/devcash-spl)                          | [![Docs.rs](https://docs.rs/devcash-spl/badge.svg)](https://docs.rs/devcash-spl)                                  |
| `devcash-client`         | Rust client for devcash privacy programs              | [![crates](https://img.shields.io/crates/v/devcash-client?color=blue)](https://crates.io/crates/devcash-client)                    | [![Docs.rs](https://docs.rs/devcash-client/badge.svg)](https://docs.rs/devcash-client)                            |
| `@devcash/sdk`           | TypeScript client for devcash programs                    | [![npm](https://img.shields.io/npm/v/@devcash/sdk.svg?color=blue)](https://www.npmjs.com/package/@devcash/sdk)                     | [![Docs](https://img.shields.io/badge/docs-typedoc-blue)](https://devcash.github.io/devcash/ts/index.html)        |
| `@devcash/cli`           | CLI to support building and managing private apps    | [![npm](https://img.shields.io/npm/v/@devcash/cli.svg?color=blue)](https://www.npmjs.com/package/@devcash/cli)                     | [![Docs](https://img.shields.io/badge/docs-typedoc-blue)](https://devcash.github.io/devcash/cli/commands.html)    |

## Note

- **devcash is in active development, so all APIs are subject to change.**
...
```rust
use devcash_lang::prelude::*;
use devcash_lang::privacy::*;
...
devcash token create --name "PrivateToken" --symbol "PVTK" --privacy shielded

# Deploy with privacy features
devcash deploy --privacy-level high

# Create shielded addresses
devcash address generate --type shielded

# Send encrypted transaction
devcash transfer --to <shielded-address> --amount 100 --private
```
...
For more, see the [examples](https://github.com/devcash/devcash/tree/master/examples) and [tests](https://github.com/devcash/devcash/tree/master/tests) directories.

## Architecture

devcash uses a privacy-first runtime that integrates cryptographic primitives directly into Solana programs. The framework handles:
...
devcash implements multiple privacy-preserving techniques:
...
devcash is licensed under [Apache 2.0](./LICENSE).

Unless you explicitly state otherwise, any contribution intentionally submitted for inclusion in devcash by you, as defined in the Apache-2.0 license, shall be licensed as above, without any additional terms or conditions.

## Contribution

Thank you for your interest in contributing to devcash!
Please see the [CONTRIBUTING.md](./CONTRIBUTING.md) to learn how.

## The Future is Private

devcash represents the future of blockchain privacy: a world where users control their financial data, where transactions are confidential by default, and where privacy and performance coexist seamlessly on Solana.

With Solana's commitment to scalability and decentralization, combined with devcash's privacy-first approach, we're building the foundation for truly private, decentralized finance.

### Thanks ❤️

<div align="center">
  <a href="https://github.com/devcash/devcash/graphs/contributors">
    <img src="https://contrib.rocks/image?repo=devcash/devcash" width="100%" />
  </a>
</div>
...
- [devcash Network Documentation](#) (Coming soon)
...
Privacy and security are paramount. devcash undergoes regular security audits by leading blockchain security firms. For security researchers, please see our [SECURITY.md](./SECURITY.md) for responsible disclosure.

## Community

Join our growing community of privacy advocates and developers:

- **Discord**: [discord.gg/devcash](https://discord.gg/devcash)
- **Twitter**: [@devcash](https://twitter.com/devcash)
- **Forum**: [forum.devcash.com](https://forum.devcash.com)
- **Telegram**: [t.me/devcash](https://t.me/devcash)

## Acknowledgments

devcash builds on the groundbreaking work of privacy-focused cryptocurrencies like Zcash and combines it with Solana's industry-leading performance. Special thanks to the Solana Foundation, the zero-knowledge cryptography research community, and all our contributors.

**Privacy is a right, not a privilege. Build with devcash.**
